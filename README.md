...
The `gsp_correlation.py` script evaluates the relationship between GSP and established metrics like RMSD, TM-score, INF_all, and lDDT. It automatically handles metric orientations (where higher is better for GSP, lDDT, and INF, but lower is better for RMSD).
